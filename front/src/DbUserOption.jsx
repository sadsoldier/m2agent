...
import { DbUserUpdate } from './DbUserUpdate'
import { DbUserDelete } from './DbUserDelete'

export class DbUserOption extends Component {
                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                                ...
                                <div className="modal-body">
                                            <DbUserUpdate user={this.props.user}
                                                            updateCallback={this.props.updateCallback}
                                                            hideCallback={this.hideForm} />
                                            <div className="dropdown-divider"></div>
                                            <DbUserDelete user={this.props.user}
                                                            updateCallback={this.props.updateCallback}
                                                            hideCallback={this.hideForm} />
