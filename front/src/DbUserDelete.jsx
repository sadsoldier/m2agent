...
export class DbUserDelete extends Component {
    ...
    @autobind
    showForm() {
        $("#delete-dbuser-" + this.props.user.username).modal('show')
    }

    @autobind
    hideForm() {
        $("#delete-dbuser-" + this.props.user.username).modal('hide')
    }

    @autobind
    deleteUser() {
        axios.post('/api/v1/dbuser/delete', {
    ...
    @autobind
    makeId(base) {
        return 'user-delete-' + base + '-' + this.props.user.username
    }
    ...
    render() {
        return (
            <Fragment>
                ...
                <div className="modal fade" id={"delete-dbuser-" + this.props.user.username} tabIndex="-1" role="dialog"  ref="form">
